 ...
 */
public class GetOrderSyncPendingUseCaseImpl implements GetOrderSyncPendingUseCase {
    ...
    public GetOrderSyncPendingUseCaseImpl(ThreadExecutor threadExecutor, PostExecutionThread postExecutionThread) {
    ...
    public void run() {
        ...
        this.orderService.getAllSyncPending(VendasUp.getBranchOffice().getBranchOfficeID(), orderListSyncCallback);

    }

    private final OrderService.OrderListSyncCallback orderListSyncCallback = new OrderService.OrderListSyncCallback() {
