...
public class RestClient {
    ...
    public final RESTResponse get() throws IOException, SyncronizationException {
        ...
        //try {
            OauthAccess accessToken = OauthController.getAccessToken();

            httpget.setHeader("Authorization", "Bearer ".concat( accessToken.getValue()));
        ...
        /*} catch (Exception e) {
            Log.e("KRATOS", "Falha ao acessar Web service com o metodo GET", e);
            restResponse = new RESTResponse(0, "Ocorreu algum problema. Tente novamente em alguns instantes.");
        }*/
        return restResponse;
    }

    public final RESTResponse post(String url, String json) {
        ...
        try {
            ...
            httpPost.setHeader("Authorization", "Bearer ".concat( accessToken.getValue()) );
